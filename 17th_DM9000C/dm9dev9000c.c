/*
*used menufacturer cord transplant
*/
...
int __init dmfe_probe1(struct net_device *dev)
{
	...
	do {
		outb(DM9KS_VID_L, iobase);  /*DM9000C的索引寄存器(cmd 0)*/
		id_val = inb(iobase + 4);       /*读DM9000C的数据寄存器(cmd 1)*/
...
int __init dm9000c_init (void)
{
	...
	iobase = (int)ioremap(0x20000000, 1024);   /*modify*/

	irq =IRQ_EINT7;                                  /*modify*/

	/*setup s3c2440 memory control */
